...
namespace BackendTestTask.Authentification
{
    public class ApiKeyAuthenticationHandler : AuthenticationHandler<ApiKeyAuthenticationOptions>
    {
        ...
        private readonly IGetAllApiKeyQuery _getApiKeyQuery;
        ...
        public ApiKeyAuthenticationHandler(
            ...
            UrlEncoder encoder,
            ISystemClock clock,
            IGetAllApiKeyQuery getApiKeyQuery) : base(options, logger, encoder, clock)
        {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var existingApiKey = await _getApiKeyQuery.CheckApiKey(providedApiKey);
